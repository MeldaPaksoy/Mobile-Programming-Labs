...
List<Book> bookList = [
  Book(
      ...
      year: 2008,
      imageUrl:
      'https://www.storytel.com/images/e/640x640/0001149185.jpg'),
  Book(
      ...
      year: 2008,
      imageUrl:
      'https://img.kitapyurdu.com/v1/getImage/fn:4730336/wh:true/wi:800'),
  Book(
  ...
  Book(
      ...
      year: 1870,
      imageUrl:
      'https://www.storytel.com/images/e/640x640/0000904656.jpg'),
  Book(
      ...
      ,      year: 1759,
      imageUrl:
      'https://cdn.kobo.com/book-images/d1d264bb-edf9-4405-ab53-eb13f82342ab/353/569/90/False/great-expectations-398.jpg'),
...
leading: Icon(Icons.bookmark , color: Colors.white, size: 50,),
      ),
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            leading: Image.network(book.imageUrl, width: 50, fit: BoxFit.contain ),
            title: Text(book.title),
            subtitle: Text('Published: ${book.year}'),
            onTap: () {
                      ...
                      child: Column(
                        children: [
                          AppBar( backgroundColor: Colors.green,
                           ...
                           // leading: IconButton(Icons.arrow_back , color: Colors.white, size: 30,),
                            leading: IconButton(
                              icon: Icon(Icons.arrow_back, color: Colors.white, size: 30),
                              onPressed: () {
                                Navigator.pop(context); // Closes the showModalBottomSheet
                              },
                            ),
                          ),
                          SizedBox(height: 10),

                          Image.network(book.imageUrl, width: 50, fit: BoxFit.contain),
                          Text('${book.year}', style: TextStyle(fontSize: 20)),
                          SizedBox(height: 10),
                          Text(
                            book.title,
                            style: TextStyle(
